...
static char* nouns[] = {
    "Cowboy", "Dream", "Dreamer", "Settlers", "Gunslingers", "Maverick", "Skies", "Class", "Sheriff", "Desert", "Arms", "Beauty", "Redhead", "Gaslight", "Lover", "Ruby", "Widow", "Mine", "Hope", "Bluff", "Plains", "Lariat", "Sierra", "Antelope", "Prairie", "Horizon", "Graveyard", "Churchyard", "Hawk", "Landowner", "Soul", "Souls", "Touch", "Meadow", "Boots", "Spurs", "Saddle", "Gold", "Clouds", "Men", "Women", "Mountains", "Guitar", "Smoke", "Cattle", "Drive", "Stirrup", "Ice", "Snow", "Night", "Silk", "Secret", "Secrets", "Dove", "Coyote", "Wagon", "Solitude", "Husband", "Wife", "Man", "Woman", "Boy", "Loner", "Wagons", "Land", "Girl", "Raven", "Truth", "Soldier", "Beau", "Eagle", "Sierras", "Outlaw", "Body", "Captive", "Evening", "Velvet", "Lash", "Deer", "Rustlers", "Leather", "Teacher", "Lake", "Lawman", "Temptation", "Wolves", "Spinet", "Drums", "Rein", "Rainbow", "Rain", "Flight", "Flying", "Lark", "Dust", "Sun", "Gun", "Soaring", "Stallion", "Wings", "Mist", "Sky", "Wind", "Race", "Vultures", "Seeker", "Winter", "River", "Door", "Mountain", "Magic", "Yucca", "Brook", "Honor", "Gate", "Cloud", "Glen", "Duster", "End", "Beginning", "Feather", "Tale", "Waltz", "Tales", "Steer", "Church", "Fences", "Gentleman", "Lady", "Vine", "Path", "Willow", "Birch", "Birches", "Trail", "Petals", "Destiny", "Pine", "Garden", "Theft", "Thief", "Legend", "Rifle", "Squaw", "Arapahoe", "Chance", "Oak", "Spark", "Sparks", "Stream", "Streams", "Mare", "Canoe", "Wolf", "Bible", "Darkness", "Silence", "Kiss", "Book", "Butterfly", "Death", "Sioux", "Shadow", "Ring", "Diary", "Storm", "Storms", "Bullets", "Holster", "Winchester", "Necklace", "Stranger", "Lord", "Lords", "Navajo", "Tumbleweed", "Barrel", "Star", "Locket", "Stars", "Painting", "Heart", "Heat", "Cougar", "Bandit", "Sketch", "Twilight", "Moon", "Shores", "Paint", "Pinto", "Bullet", "Calf", "Town", "Frame", "Courage", "Doctor", "School", "Rose", "Apache", "Spinster", "Roses", "Stone", "Stones", "Panel", "Creek", "Pass", "Badlands", "Butte", "Lamp", "Tree", "Rattlesnake", "Rancher", "Tracks", "Buffalo", "Spring", "Autumn", "Colt", "Spirit", "Return", "Father", "Mother", "Brave", "Savage", "Summer", "Winter", "Dog", "Legacy", "Birth", "Healer", "Healing", "Year", "Years", "Death", "Dying", "Fall", "Lace", "Luck", "Pearl", "Treasure", "Tears", "Son", "Sons", "Child", "Children", "Riders", "Destruction", "Devotion", "Promise", "Gift", "Word", "Stable", "Barn", "Renegade", "Words", "Thought", "Thoughts", "Guard", "Angel", "Angels", "Search", "Eye", "Lamplight", "Eyes", "Danger", "Game", "Fire", "Flame", "Flames", "Bride", "Time", "Spaniard", "Light", "Lights", "Doors", "Window", "Windows", "Circus", "Road", "Sombrero", "Dirt", "Ashes", "Memory", "Thorn", "Thorns", "Name", "Names", "Dozen", "Senorita", "Sage", "Future", "Past", "Nothing", "Arroyo", "Gulch", "Mesa", "Medicine", "Map", "Bible", "Way", "Lily", "Valley", "Abyss", "Hunter", "Basin", "Roundup", "Canyon", "Edge", "Smile", "Embrace", "Diamond", "Grave"};

static char* adjectives[] = {
    "Lost", "Only", "Last", "First", "Untamed", "Fearless", "Third", "Sacred", "Bold", "Lovely", "Iron", "Fourth", "Missing", "Shadowy", "Seventh", "Towering", "Unabashed", "Unloved", "Flaming", "Fifth", "Vacant", "Lace", "Cold", "Hot", "Golden", "Enthralled", "Lone", "Silent", "Solitary", "Unknown", "Sixth", "Brave", "Whispering", "Smooth", "Fiery", "Enchanted", "Silken", "Rough", "Frozen", "Wild", "Moonlit", "Slender", "Trembling", "Fallen", "Lacey", "Ragged", "Burned", "Splintered", "Silk", "Distant", "Reluctant", "Haunted", "Magnificent", "Luscious", "Sparkling", "Raven", "White", "Hurried", "Ancient", "Hidden", "Jeweled", "Pastel", "Captured", "Stolen", "Miraculous", "Lilac", "Cloudy", "Unbound", "Growing", "Kissing", "Verdant", "Red", "Azure", "Rising", "Falling", "Elemental", "Unfinished", "Bound", "Prized", "Dungeon", "Obsessed", "Unwilling", "Dancing", "Hard", "Eager", "Ravaged", "Sleeping", "Mysterious", "Proud", "Wanton", "Professional", "Willing", "Devoted", "Auburn", "Misty", "Irresistible", "Locked", "Secluded", "Ruby", "Final", "Missing", "Plaintive", "Dark", "Darkest", "Silver", "Silvery", "Living", "Yearning", "Black", "White", "Entwined", "Invisible", "Legato", "Next", "Seventh", "Scarlet", "Green", "Blue", "Poignant", "Violet", "Grey", "Wounded", "Bloody", "Emerald", "Crystal", "Lyrical", "Sharp", "Delicious", "Shattered", "Dangerous", "Somber", "Deep", "Twinkling", "Dwindling", "Absent", "Soft", "Fierce", "Vacant", "Burning", "Summer", "Loneliest", "Some", "No", "All", "Tinkling", "Grave", "Engraved", "Living", "Dead", "Happiest", "Echoing", "Every", "Each", "Which", "What", "Playful", "Slumbering", "Weeping", "Softer", "Dying", "Lonely", "Laughing", "Whispering", "Forgotten", "Empty", "Frozen", "Magical", "Unlucky", "Lucky", "New", "Tentative", "Clear", "Faraway", "Sweet", "Hungry", "Autumn", "Spring", "Winter", "Broken", "Searching", "Fleeting", "Spellbound"};
...
box_muller (double mu, double sigma)
{
	...
	a = 2 * 3.14159 * (rand () / (double) RAND_MAX);
...
generate_book (struct book* book)
{
	...
	{
		case 0:
			sprintf (book->title, "%s %s", adjectives[rand () % num_adj], nouns[rand () % num_nouns]);
			break;
		case 1:
			sprintf (book->title, "The %s %s", adjectives[rand () % num_adj], nouns[rand () % num_nouns]);
			break;
		case 2:
			sprintf (book->title, "%s of %s", nouns[rand () % num_nouns], nouns[rand () % num_nouns]);
			break;
		case 3:
			sprintf (book->title, "The %s's %s", nouns[rand () % num_nouns], nouns[rand () % num_nouns]);
			break;
		case 4:
			sprintf (book->title, "The %s of the %s", nouns[rand () % num_nouns], nouns[rand () % num_nouns]);
			break;
		case 5:
			sprintf (book->title, "%s in the %s", nouns[rand () % num_nouns], nouns[rand () % num_nouns]);
			break;
		case 6:
			sprintf (book->title, "The %s of the %s %s", nouns[rand () % num_nouns], adjectives[rand () % num_adj], nouns[rand () % num_nouns]);
			break;
		case 7:
		default:
			// If something goes wrong, just default to the eigth pattern
			sprintf (book->title, "The %s and the %s", nouns[rand () % num_nouns], nouns[rand () % num_nouns]);
			break;
	}
}
...
//=============================================================================
static void
profile_timed_op (struct profile* p, int (*op) (struct profile* p, int i), double* total_time, double* avg_time, double* var_time, int* errors, int* total_ops, size_t iterations)
{
